...
The modal must re-render to display the checkmarks. If I added React.memo,   
...
Consequently, the child DataTable inside it is automatically protected from unnecessary re-renders.   
Adding React.memo to DataTable would create redundant "double memoization".
